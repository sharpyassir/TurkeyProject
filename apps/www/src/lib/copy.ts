...
const en: Copy = {
  ...
  products: {
    ...
    groups: [
      { name: 'Core Cloud', desc: 'Servers, Kubernetes, volumes, load balancers, DNS, object storage, public IPs, snapshots, firewalls and monitoring today. VPC is next.', items: ['Servers', 'Managed servers', 'Kubernetes', 'Volumes', 'Load balancers', 'DNS', 'Object storage', 'Snapshots', 'Public IPs', 'Firewalls', 'Monitoring'], live: true },
...
const tr: Copy = {
  ...
  products: {
    ...
    groups: [
      { name: 'Çekirdek Bulut', desc: 'Bugün sunucular, diskler, yük dengeleyiciler, DNS, nesne depolama, genel IP’ler, anlık görüntüler, güvenlik duvarları ve izleme. Sırada VPC var.', items: ['Sunucular', 'Yönetilen sunucular', 'Kubernetes', 'Diskler', 'Yük dengeleyiciler', 'DNS', 'Nesne depolama', 'Anlık görüntüler', 'Genel IP’ler', 'Güvenlik duvarları', 'İzleme'], live: true },
...
const ar: Copy = {
  ...
  products: {
    ...
    groups: [
      { name: 'السحابة الأساسية', desc: 'الخوادم والأقراص وموازنات الحمل وDNS والتخزين الكائني وعناوين IP العامة واللقطات وجدران الحماية والمراقبة اليوم. الشبكات الخاصة لاحقًا.', items: ['الخوادم', 'الخوادم المُدارة', 'Kubernetes', 'الأقراص', 'موازنات الحمل', 'DNS', 'التخزين الكائني', 'اللقطات', 'عناوين IP العامة', 'جدران الحماية', 'المراقبة'], live: true },
