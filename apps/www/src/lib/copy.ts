...
const en: Copy = {
  meta: { title: 'pgcloud: the developer cloud for Türkiye, built for people and AI agents', description: 'Get a server in 60 seconds. Hourly billing in dollars or lira with e-Fatura, data that stays in Türkiye, one click apps, and API tokens your AI agents can use safely.' },
  ...
  hero: {
    badge: 'First region in Türkiye, launching 2027',
    h1a: 'The developer cloud for Türkiye. Built for people ', h1b: 'and AI agents',
    lead: 'Get a server in 60 seconds. Pay by the hour in dollars or lira with a proper e-Fatura. Your data stays in Türkiye. And your AI agents get API tokens with a spending cap and a human in the loop.',
    ctaPrimary: 'Start with $100 in credit', ctaSecondary: 'See how agents deploy',
    stats: [['60 s', 'to a running server'], ['$4 / mo', 'entry server, billed hourly'], ['100%', 'of your data stays in Türkiye']],
  },
  ...
  products: {
    ...
    groups: [
      { name: 'Core Cloud', desc: 'Servers, volumes, load balancers, DNS, public IPs, snapshots, firewalls and monitoring today. VPC and object storage are next.', items: ['Servers', 'Volumes', 'Load balancers', 'DNS', 'Snapshots', 'Public IPs', 'Firewalls', 'Monitoring'], live: true },
  ...
  pricing: {
    ...
    noteTry: (rate) => `Lira prices are our dollar prices converted at today's rate of ${rate} TRY per USD. Your invoice uses the rate on the day it is issued. `,
    noteUsd: 'Turkish customers can pay in lira at the exchange rate of the invoice date. ',
    noteTail: (snapshot) => `KDV (20%) is added for Turkish customers. A public IP is included with every server. Snapshots cost ${snapshot} per GB per month. Backups cost 20% of the plan.`,
  },
  ...
  footer: {
    tagline: 'The developer cloud for Türkiye.',
    cols: [
...
const tr: Copy = {
  meta: { title: 'pgcloud: Türkiye için geliştirici bulutu, insanlar ve yapay zeka ajanları için', description: '60 saniyede sunucu. Dolar veya lira ile saatlik faturalama ve e-Fatura, Türkiye’de kalan veri, tek tıkla uygulamalar ve yapay zeka ajanlarının güvenle kullanabileceği API tokenları.' },
  ...
  hero: {
    badge: 'Türkiye’deki ilk bölge, 2027’de açılıyor',
    h1a: 'Türkiye için geliştirici bulutu. İnsanlar ', h1b: 've yapay zeka ajanları için',
    lead: '60 saniyede sunucunuz hazır. Dolar veya lira ile saatlik ödeyin, e-Fatura alın. Verileriniz Türkiye’de kalır. Yapay zeka ajanlarınız harcama limitli ve insan onaylı API tokenları kullanır.',
    ctaPrimary: '100 $ kredi ile başla', ctaSecondary: 'Ajanlar nasıl kurulum yapıyor',
    stats: [['60 sn', 'çalışan bir sunucuya'], ['4 $ / ay', 'giriş sunucusu, saatlik faturalanır'], ['%100', 'veriniz Türkiye’de kalır']],
  },
  ...
  trust: [
    ['🇹🇷', 'Türkiye’de bölge', 'Türkiye, Orta Doğu ve Kafkasya’da düşük gecikme'],
    ['$', 'Dolar bazlı fiyat, lira veya dolar ile ödeme', 'e-Fatura ve e-Arşiv, iyzico, kartlar'],
    ['🔒', 'Veri Türkiye’de kalır', 'Tasarımdan itibaren KVKK uyumlu'],
  ...
  products: {
    ...
    groups: [
      { name: 'Çekirdek Bulut', desc: 'Bugün sunucular, diskler, yük dengeleyiciler, DNS, genel IP’ler, anlık görüntüler, güvenlik duvarları ve izleme. Sırada VPC ve nesne depolama var.', items: ['Sunucular', 'Diskler', 'Yük dengeleyiciler', 'DNS', 'Anlık görüntüler', 'Genel IP’ler', 'Güvenlik duvarları', 'İzleme'], live: true },
      ...
      { name: 'Veri ve Öğrenme', desc: 'pgvector ile yönetilen PostgreSQL, MySQL ve Redis.', items: ['Yönetilen veritabanları', 'Önbellek'], live: false },
  ...
  pricing: {
    ...
    noteTry: (rate) => `Lira fiyatları, dolar fiyatlarımızın bugünkü ${rate} TL/USD kuruyla çevrilmiş halidir. Faturanızda düzenlendiği günün kuru kullanılır. `,
    noteUsd: 'Türkiye’deki müşteriler fatura tarihindeki kurla lira olarak ödeyebilir. ',
    noteTail: (snapshot) => `Türkiye’deki müşteriler için %20 KDV eklenir. Her sunucuya bir genel IP dahildir. Anlık görüntüler GB başına aylık ${snapshot}. Yedekler plan fiyatının %20’si.`,
  },
  ...
  compare: {
    ...
    rows: [
      ['Bölge', 'Türkiye', 'Almanya veya Hollanda', 'Türkiye'],
      ['Faturalama', 'Saatlik, dolar veya lira', 'Aylık veya saatlik, dolar', 'Aylık, lira'],
      ['e-Fatura ve e-Arşiv', 'Yerleşik', 'Hayır', 'Evet'],
      ['Veri Türkiye’de kalır (KVKK)', 'Evet', 'Hayır', 'Evet'],
  ...
  footer: {
    tagline: 'Türkiye için geliştirici bulutu.',
    cols: [
      ...
      ['Hukuki', ['Koşullar', 'Gizlilik (KVKK)', 'SLA', 'Kabul edilebilir kullanım']],
    ],
...
const ar: Copy = {
  meta: { title: 'pgcloud: سحابة المطورين في تركيا، للأشخاص ولوكلاء الذكاء الاصطناعي', description: 'خادم خلال 60 ثانية. فوترة بالساعة بالدولار أو الليرة مع فاتورة إلكترونية، بيانات تبقى في تركيا، تطبيقات بنقرة واحدة، ورموز API يمكن لوكلاء الذكاء الاصطناعي استخدامها بأمان.' },
  ...
  hero: {
    badge: 'أول منطقة في تركيا، تنطلق في 2027',
    h1a: 'سحابة المطورين في تركيا. مصممة للأشخاص ', h1b: 'ولوكلاء الذكاء الاصطناعي',
    lead: 'احصل على خادم خلال 60 ثانية. ادفع بالساعة بالدولار أو الليرة مع فاتورة إلكترونية رسمية. بياناتك تبقى في تركيا. ووكلاء الذكاء الاصطناعي لديك يحصلون على رموز API بحد إنفاق وموافقة بشرية.',
    ctaPrimary: 'ابدأ برصيد 100 دولار', ctaSecondary: 'شاهد كيف ينشر الوكلاء',
    stats: [['60 ث', 'حتى يعمل الخادم'], ['4 $ / شهر', 'خادم مبتدئ، يُفوتر بالساعة'], ['100%', 'من بياناتك تبقى في تركيا']],
  },
  ...
  trust: [
    ['🇹🇷', 'منطقة في تركيا', 'زمن استجابة منخفض في تركيا والشرق الأوسط والقوقاز'],
    ['$', 'الأسعار بالدولار، والدفع بالليرة أو الدولار', 'فاتورة إلكترونية وأرشيف إلكتروني، iyzico، بطاقات'],
    ['🔒', 'البيانات تبقى في تركيا', 'متوافق مع قانون حماية البيانات التركي KVKK'],
  ...
  products: {
    ...
    groups: [
      { name: 'السحابة الأساسية', desc: 'الخوادم والأقراص وموازنات الحمل وDNS وعناوين IP العامة واللقطات وجدران الحماية والمراقبة اليوم. الشبكات الخاصة والتخزين الكائني لاحقًا.', items: ['الخوادم', 'الأقراص', 'موازنات الحمل', 'DNS', 'اللقطات', 'عناوين IP العامة', 'جدران الحماية', 'المراقبة'], live: true },
      ...
      { name: 'البيانات والتعلم', desc: 'PostgreSQL مُدار مع pgvector، وMySQL وRedis.', items: ['قواعد بيانات مُدارة', 'التخزين المؤقت'], live: false },
  ...
  pricing: {
    ...
    noteTry: (rate) => `أسعار الليرة هي أسعارنا بالدولار محولة بسعر اليوم ${rate} ليرة للدولار. فاتورتك تستخدم سعر يوم إصدارها. `,
    noteUsd: 'يمكن للعملاء في تركيا الدفع بالليرة بسعر صرف تاريخ الفاتورة. ',
    noteTail: (snapshot) => `تُضاف ضريبة القيمة المضافة (20%) للعملاء في تركيا. عنوان IP عام مشمول مع كل خادم. اللقطات ${snapshot} لكل GB شهريًا. النسخ الاحتياطي 20% من سعر الخطة.`,
  },
  ...
  compare: {
    ...
    rows: [
      ['المنطقة', 'تركيا', 'ألمانيا أو هولندا', 'تركيا'],
      ['الفوترة', 'بالساعة، بالدولار أو الليرة', 'شهريًا أو بالساعة، بالدولار', 'شهريًا، بالليرة'],
      ['فاتورة إلكترونية وأرشيف إلكتروني', 'مدمج', 'لا', 'نعم'],
      ['البيانات تبقى في تركيا (KVKK)', 'نعم', 'لا', 'نعم'],
      ['API عام وTerraform', 'نعم', 'نعم', 'نادرًا'],
      ['رموز وكلاء بحد إنفاق', 'نعم', 'لا', 'لا'],
      ['لوحة تحكم بالتركية والعربية', 'نعم', 'لا', 'التركية فقط'],
    ],
  },
  ...
  footer: {
    tagline: 'سحابة المطورين في تركيا.',
    cols: [
      ...
      ['قانوني', ['الشروط', 'الخصوصية (KVKK)', 'اتفاقية مستوى الخدمة', 'الاستخدام المقبول']],
    ],
