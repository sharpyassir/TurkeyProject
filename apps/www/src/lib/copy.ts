...
const ar: Copy = {
  ...
  terminal: { ready: 'WordPress جاهز على https://185.0.113.42 والفوترة 0.04 ر.س في الساعة', orAgent: '# أو دع وكيلك يفعل ذلك، بحد إنفاق', capNote: '# حد 15 $ شهريًا، الحذف يحتاج موافقة' },
  trust: [
