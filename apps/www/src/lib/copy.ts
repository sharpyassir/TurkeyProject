...
const en: Copy = {
  ...
  products: {
    ...
    groups: [
      ...
      { name: 'Data & Learning', desc: 'Managed PostgreSQL with pgvector, automatic failover and nightly backups today. Valkey and MySQL are next.', items: ['Managed PostgreSQL', 'Backups'], live: true },
...
const tr: Copy = {
  ...
  products: {
    ...
    groups: [
      ...
      { name: 'Veri ve Öğrenme', desc: 'Bugün pgvector, otomatik yük devretme ve gece yedekleriyle yönetilen PostgreSQL. Sırada Valkey ve MySQL var.', items: ['Yönetilen PostgreSQL', 'Yedekler'], live: true },
...
const ar: Copy = {
  ...
  products: {
    ...
    groups: [
      ...
      { name: 'البيانات والتعلم', desc: 'PostgreSQL مُدار مع pgvector وتبديل تلقائي عند الفشل ونسخ احتياطي ليلي اليوم. Valkey وMySQL لاحقًا.', items: ['PostgreSQL مُدار', 'النسخ الاحتياطي'], live: true },
