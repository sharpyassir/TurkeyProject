...
const en = {
  ...
  // server detail
  tabOverview: 'Overview', tabMetrics: 'Metrics', tabPower: 'Power and resize', tabNetworking: 'Networking', tabSnapshots: 'Snapshots', tabActivity: 'Activity',
...
const tr: Dict = {
  ...
  tabOverview: 'Genel bakış', tabMetrics: 'Metrikler', tabPower: 'Güç ve boyut', tabNetworking: 'Ağ', tabSnapshots: 'Anlık görüntüler', tabActivity: 'Etkinlik',
...
const ar: Dict = {
  ...
  tabOverview: 'نظرة عامة', tabMetrics: 'المقاييس', tabPower: 'الطاقة والحجم', tabNetworking: 'الشبكة', tabSnapshots: 'اللقطات', tabActivity: 'النشاط',
