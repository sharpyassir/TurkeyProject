...
@Module({ imports: [MonitoringModule, LbModule, DnsModule, ObjectsModule, StorageModule, DatabasesModule, KubernetesModule, ScheduleModule.forRoot(), BillingModule, EventsModule], providers: [JobsService] })
