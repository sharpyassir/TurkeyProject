...
export class SpendService {
  ...
  async monthlyPriceMinor(resourceType: 'server' | 'public_ip' | 'snapshot' | 'backup' | 'volume' | 'load_balancer' | 'object_storage' | 'database' | 'managed_server', sku: string, currency: 'USD' | 'SAR') {
