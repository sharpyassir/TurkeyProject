...
func (p *pgcloudProvider) Resources(_ context.Context) []func() resource.Resource {
	return []func() resource.Resource{NewServerResource, NewVolumeResource, NewLoadBalancerResource, NewDomainResource, NewDnsRecordResource, NewBucketResource, NewStorageKeyResource, NewDatabaseResource, NewKubernetesResource, NewFirewallResource, NewSshKeyResource}
}
